...
//couleur de la map selon la population (min max)
//max = plus sombre, min = plus clair
const colorScale = scaleLinear()
//nombre min d'habitant et max (selon le db.json)
  .domain([0, 6300000])
  .range(["#a72bb5", "#0376db"]);
...
const Map = () => {
  ...
  //fonction qui permet d'appeler la donnée ("api") des pays
  const getData = () => {
  ...
  //fonction qui permet d'appeler la donnée ("api") des continents
  const getContData = () => {
